...
[[ $VAULT_SECRETS_PLUGIN_ENABLED == "true" ]] && PLUGINS_ENABLED+=("vault-secrets")
...
export BUILDKITE_PLUGIN_VAULT_SECRETS_ROLE=$BUILDKITE_PLUGIN_VAULT_SECRETS_ROLE
export BUILDKITE_PLUGIN_VAULT_SECRETS_AUTH_METHOD=${BUILDKITE_PLUGIN_VAULT_SECRETS_AUTH_METHOD:-aws}
